...
restaurant)
//  - its max size (the maximum number of orders the restaurant can 
handle)
...
/**
 * Creates a restaurant with a maximum size and the expected number of 
orders.
 ...
 *  - return the order
 * 
 * If there are no orders left, this function should notify the other 
cooks
